...
public final class UserServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.shopping.stubs.user.UserRequestSave,
      com.shopping.stubs.user.UserResponseSave> getSaveUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "saveUser",
      requestType = com.shopping.stubs.user.UserRequestSave.class,
      responseType = com.shopping.stubs.user.UserResponseSave.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.shopping.stubs.user.UserRequestSave,
      com.shopping.stubs.user.UserResponseSave> getSaveUserMethod() {
    io.grpc.MethodDescriptor<com.shopping.stubs.user.UserRequestSave, com.shopping.stubs.user.UserResponseSave> getSaveUserMethod;
    if ((getSaveUserMethod = UserServiceGrpc.getSaveUserMethod) == null) {
      synchronized (UserServiceGrpc.class) {
        if ((getSaveUserMethod = UserServiceGrpc.getSaveUserMethod) == null) {
          UserServiceGrpc.getSaveUserMethod = getSaveUserMethod =
              io.grpc.MethodDescriptor.<com.shopping.stubs.user.UserRequestSave, com.shopping.stubs.user.UserResponseSave>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "saveUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.shopping.stubs.user.UserRequestSave.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.shopping.stubs.user.UserResponseSave.getDefaultInstance()))
  ...
  public static abstract class UserServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void saveUser(com.shopping.stubs.user.UserRequestSave request,
        io.grpc.stub.StreamObserver<com.shopping.stubs.user.UserResponseSave> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.shopping.stubs.user.UserRequestSave,
                com.shopping.stubs.user.UserResponseSave>(
  ...
  public static final class UserServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserServiceBlockingStub> {
    ...
    /**
     */
    public com.shopping.stubs.user.UserResponseSave saveUser(com.shopping.stubs.user.UserRequestSave request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class UserServiceFutureStub extends io.grpc.stub.AbstractFutureStub<UserServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.shopping.stubs.user.UserResponseSave> saveUser(
        com.shopping.stubs.user.UserRequestSave request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SAVE_USER:
          serviceImpl.saveUser((com.shopping.stubs.user.UserRequestSave) request,
              (io.grpc.stub.StreamObserver<com.shopping.stubs.user.UserResponseSave>) responseObserver);
          break;
        default:
